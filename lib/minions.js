...
if (typeof require === 'function') sublibraries.node = require('./minions.node');

var Minions = function(sublibrariesToLoad) {
	if (typeof sublibrariesToLoad === 'object' && sublibrariesToLoad instanceof Array) {
		for (var i=0; i<sublibrariesToLoad.length;i++) {
			if (typeof sublibraries[sublibrariesToLoad[i]] === 'object') {
...
Minions.prototype.alias = function(alias, func, description) {
	if (typeof _aliases === 'undefined') _aliases = {};
	if (typeof func === 'function') {
		if (typeof alias === 'string') var aliases = [ alias ]; 
		else aliases = alias;
		for (var i=0; i<aliases.length; i++) {
			_aliases[aliases[i]] = func;
		}
