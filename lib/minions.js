...
Minions.prototype.waitForAll = function() {
	if (arguments.length === 2) {
		var callList = arguments[0];
		var callAfter = arguments[1];
	} else if (arguments.length === 3) {
		var callList = {};
		for (var n in arguments[1]) {
			callList[n] = {};
			callList[n].func = arguments[0];
			callList[n].parameters = arguments[1][n];
		}
		var callAfter = arguments[2];
	}
...
Minions.prototype.waitForAll.prototype.run = function() {
	...
	var cb = function(name, func, scope) {
		return function() {
